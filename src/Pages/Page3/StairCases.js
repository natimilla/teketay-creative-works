...
function Stair_cases(){
    ...
    useEffect(()=>{
        const fetchData=async()=>{
           try{
            setLoading(true)
            const response=await fetch('https://teketay-creative-works-default-rtdb.firebaseio.com/stairs.json')
    ...
    return <div className={classes.container}>
        <div className={classes.heading}>Stair Handels</div>
